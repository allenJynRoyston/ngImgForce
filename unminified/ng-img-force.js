 ...
 * by Allen Royston
 *
 * This is just a derivitive of ngImgCropExtended, which can be found here:
...
var crop = angular.module('ngImgForce', []);
...
crop.factory('cropHost', ['$document', '$q', 'cropAreaCircle', 'cropAreaRectangle', 'cropEXIF', function($document, $q, CropAreaCircle, CropAreaRectangle, cropEXIF) {
    /* STATIC FUNCTIONS */
...
crop.directive('imgForce', ['$timeout', 'cropHost', 'cropPubSub',
    ...
    return {
        ...
        link: function(scope, element /*, attrs*/ ) {
            ...
            scope.$watch('areaType', function() {
                cropHost.setAreaType('rectangle');
                updateResultImage(scope);
            });
            ...
            scope.$watch('aspectRatio', function() {
                var aspectRatio = scope.resultImageSize.w/scope.resultImageSize.h;
                cropHost.setAspect(aspectRatio)
            });
